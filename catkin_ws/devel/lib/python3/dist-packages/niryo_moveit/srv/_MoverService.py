...
"""autogenerated by genpy from niryo_moveit/MoverServiceRequest.msg. Do not edit."""
import codecs
import sys
...
import niryo_moveit.msg

class MoverServiceRequest(genpy.Message):
  _md5sum = "38b8527fd1580ad82c09e5c63e1ce4cd"
  _type = "niryo_moveit/MoverServiceRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """NiryoMoveitJoints joints_input
...
float64 w
"""
  __slots__ = ['joints_input','pick_pose','place_pose']
  _slot_types = ['niryo_moveit/NiryoMoveitJoints','geometry_msgs/Pose','geometry_msgs/Pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       joints_input,pick_pose,place_pose
    ...
    if args or kwds:
      ...
      if self.joints_input is None:
        self.joints_input = niryo_moveit.msg.NiryoMoveitJoints()
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_get_struct_6d().pack(*self.joints_input.joints))
      _x = self
      buff.write(_get_struct_28d().pack(_x.joints_input.pick_pose.position.x, _x.joints_input.pick_pose.position.y, _x.joints_input.pick_pose.position.z, _x.joints_input.pick_pose.orientation.x, _x.joints_input.pick_pose.orientation.y, _x.joints_input.pick_pose.orientation.z, _x.joints_input.pick_pose.orientation.w, _x.joints_input.place_pose.position.x, _x.joints_input.place_pose.position.y, _x.joints_input.place_pose.position.z, _x.joints_input.place_pose.orientation.x, _x.joints_input.place_pose.orientation.y, _x.joints_input.place_pose.orientation.z, _x.joints_input.place_pose.orientation.w, _x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.joints_input.joints = _get_struct_6d().unpack(str[start:end])
      _x = self
      start = end
      end += 224
      (_x.joints_input.pick_pose.position.x, _x.joints_input.pick_pose.position.y, _x.joints_input.pick_pose.position.z, _x.joints_input.pick_pose.orientation.x, _x.joints_input.pick_pose.orientation.y, _x.joints_input.pick_pose.orientation.z, _x.joints_input.pick_pose.orientation.w, _x.joints_input.place_pose.position.x, _x.joints_input.place_pose.position.y, _x.joints_input.place_pose.position.z, _x.joints_input.place_pose.orientation.x, _x.joints_input.place_pose.orientation.y, _x.joints_input.place_pose.orientation.z, _x.joints_input.place_pose.orientation.w, _x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w,) = _get_struct_28d().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    """
    try:
      buff.write(self.joints_input.joints.tostring())
      _x = self
      buff.write(_get_struct_28d().pack(_x.joints_input.pick_pose.position.x, _x.joints_input.pick_pose.position.y, _x.joints_input.pick_pose.position.z, _x.joints_input.pick_pose.orientation.x, _x.joints_input.pick_pose.orientation.y, _x.joints_input.pick_pose.orientation.z, _x.joints_input.pick_pose.orientation.w, _x.joints_input.place_pose.position.x, _x.joints_input.place_pose.position.y, _x.joints_input.place_pose.position.z, _x.joints_input.place_pose.orientation.x, _x.joints_input.place_pose.orientation.y, _x.joints_input.place_pose.orientation.z, _x.joints_input.place_pose.orientation.w, _x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.joints_input.joints = numpy.frombuffer(str[start:end], dtype=numpy.float64, count=6)
      _x = self
      start = end
      end += 224
      (_x.joints_input.pick_pose.position.x, _x.joints_input.pick_pose.position.y, _x.joints_input.pick_pose.position.z, _x.joints_input.pick_pose.orientation.x, _x.joints_input.pick_pose.orientation.y, _x.joints_input.pick_pose.orientation.z, _x.joints_input.pick_pose.orientation.w, _x.joints_input.place_pose.position.x, _x.joints_input.place_pose.position.y, _x.joints_input.place_pose.position.z, _x.joints_input.place_pose.orientation.x, _x.joints_input.place_pose.orientation.y, _x.joints_input.place_pose.orientation.z, _x.joints_input.place_pose.orientation.w, _x.pick_pose.position.x, _x.pick_pose.position.y, _x.pick_pose.position.z, _x.pick_pose.orientation.x, _x.pick_pose.orientation.y, _x.pick_pose.orientation.z, _x.pick_pose.orientation.w, _x.place_pose.position.x, _x.place_pose.position.y, _x.place_pose.position.z, _x.place_pose.orientation.x, _x.place_pose.orientation.y, _x.place_pose.orientation.z, _x.place_pose.orientation.w,) = _get_struct_28d().unpack(str[start:end])
...
def _get_struct_6d():
    ...
    return _struct_6d
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from niryo_moveit/MoverServiceResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class MoverServiceResponse(genpy.Message):
  _md5sum = "c2b40c48066c9f23bf2c1a49578cb21d"
  _type = "niryo_moveit/MoverServiceResponse"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """moveit_msgs/RobotTrajectory[] trajectories
...
class MoverService(object):
  _type          = 'niryo_moveit/MoverService'
  _md5sum = '07e33edf2aa9c8e76159dde43e741ae0'
