...
bool operator==(const ::niryo_one_msgs::PushAirVacuumPumpResponse_<ContainerAllocator1> & lhs, const ::niryo_one_msgs::PushAirVacuumPumpResponse_<ContainerAllocator2> & rhs)
{
