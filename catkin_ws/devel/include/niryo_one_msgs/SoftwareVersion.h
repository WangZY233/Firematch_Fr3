...
struct SoftwareVersion_
{
  ...
  _rpi_image_version_type rpi_image_version;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _ros_niryo_one_version_type;
...
bool operator==(const ::niryo_one_msgs::SoftwareVersion_<ContainerAllocator1> & lhs, const ::niryo_one_msgs::SoftwareVersion_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::niryo_one_msgs::SoftwareVersion_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::niryo_one_msgs::SoftwareVersion_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.ros_niryo_one_version);
