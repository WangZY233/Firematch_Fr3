...
bool operator==(const ::niryo_one_msgs::RobotMoveActionFeedback_<ContainerAllocator1> & lhs, const ::niryo_one_msgs::RobotMoveActionFeedback_<ContainerAllocator2> & rhs)
{
