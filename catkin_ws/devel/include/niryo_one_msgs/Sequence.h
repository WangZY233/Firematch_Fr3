...
struct Sequence_
{
  ...
  _updated_type updated;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _blockly_xml_type;
  _blockly_xml_type blockly_xml;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _python_code_type;
...
bool operator==(const ::niryo_one_msgs::Sequence_<ContainerAllocator1> & lhs, const ::niryo_one_msgs::Sequence_<ContainerAllocator2> & rhs)
{
...
struct Printer< ::niryo_one_msgs::Sequence_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::niryo_one_msgs::Sequence_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.blockly_xml);
    s << indent << "python_code: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.python_code);
  }
};
