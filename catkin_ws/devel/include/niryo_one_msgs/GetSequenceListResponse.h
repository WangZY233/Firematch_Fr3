...
struct GetSequenceListResponse_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector< ::niryo_one_msgs::Sequence_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::niryo_one_msgs::Sequence_<ContainerAllocator> >> _sequences_type;
...
bool operator==(const ::niryo_one_msgs::GetSequenceListResponse_<ContainerAllocator1> & lhs, const ::niryo_one_msgs::GetSequenceListResponse_<ContainerAllocator2> & rhs)
{
  return lhs.sequences == rhs.sequences;
}
